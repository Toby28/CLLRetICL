...
# data loader
parser.add_argument('--dataset', type=str, help='dataset, options:[sst2, cola, emotion, bbc];', default='sst2')
...
parser.add_argument('--basemethod', type=str, help='icl,selfprompt,votek,simcse,knn,majorityvote,zicl',default='icl')
...
parser.add_argument('--w1', type=float, help='0.3, 0.5, 1.0',default=1.0)
parser.add_argument('--w2', type=float, help='0.3, 0.5, 1.0',default=1.0)
